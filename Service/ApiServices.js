...
/**
 * @ngdoc object
 * @name lbServices.LoyaltyCard
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `LoyaltyCard` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/loyaltyCards/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#create
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
         ...
         * This usually means the response is a `LoyaltyCard` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/loyaltyCards",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#upsert
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#exists
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/loyaltyCards/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#findById
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/loyaltyCards/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#find
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#findOne
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/loyaltyCards/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#updateAll
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/loyaltyCards/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#deleteById
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#count
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/loyaltyCards/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#prototype$updateAttributes
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#updateOrCreate
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#update
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#destroyById
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LoyaltyCard#removeById
         * @methodOf lbServices.LoyaltyCard
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.LoyaltyCard#modelName
    * @propertyOf lbServices.LoyaltyCard
    * @description
    * The name of the model represented by this $resource,
    * i.e. `LoyaltyCard`.
    */
    R.modelName = "LoyaltyCard";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Account.accountType() instead.
        "prototype$__get__accountType": {
          url: urlBase + "/accounts/:id/accountType",
          method: "GET",
        },
        ...
        // INTERNAL. Use CreditCard.account() instead.
        "::get::creditCard::account": {
          url: urlBase + "/creditCards/:id/account",
          method: "GET",
        },

        // INTERNAL. Use AccountBook.account() instead.
        "::get::accountBook::account": {
          url: urlBase + "/accountBooks/:id/account",
          method: "GET",
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Account#accountType
         * @methodOf lbServices.Account
         *
         * @description
         *
        ...
        R.accountType = function() {
          ...
          var action = TargetResource["::get::account::accountType"];
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountType#moduleList
         ...
         */
        "moduleList": {
          url: urlBase + "/accountTypes/moduleList",
          method: "GET",
          isArray: true,
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountType#currencyList
         * @methodOf lbServices.AccountType
         *
         * @description
         *
         ...
         */
        "currencyList": {
          url: urlBase + "/accountTypes/:id/currencyList",
          method: "GET",
          isArray: true,
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Transaction#postTransaction
         * @methodOf lbServices.Transaction
         *
         * @description
         *
         ...
         */
        "postTransaction": {
          url: urlBase + "/transactions/postTransaction",
          method: "POST",
        },
      }
    );
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.CreditCard#account
         * @methodOf lbServices.CreditCard
         *
         * @description
         *
        ...
        R.account = function() {
          var TargetResource = $injector.get("Account");
          var action = TargetResource["::get::creditCard::account"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.AccountBook
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `AccountBook` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use AccountBook.user() instead.
        "prototype$__get__user": {
          url: urlBase + "/accountBooks/:id/user",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#create
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `AccountBook` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/accountBooks",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#upsert
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#exists
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/accountBooks/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#findById
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/accountBooks/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#find
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#findOne
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/accountBooks/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#updateAll
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/accountBooks/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#deleteById
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#count
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/accountBooks/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#prototype$updateAttributes
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#updateOrCreate
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#update
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#destroyById
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#removeById
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.AccountBook#account
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        R.account = function() {
          var TargetResource = $injector.get("Account");
          var action = TargetResource["::get::accountBook::account"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AccountBook#user
         * @methodOf lbServices.AccountBook
         *
         * @description
         *
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::accountBook::user"];
          return action.apply(R, arguments);
        };

    /**
    * @ngdoc property
    * @name lbServices.AccountBook#modelName
    * @propertyOf lbServices.AccountBook
    * @description
    * The name of the model represented by this $resource,
    * i.e. `AccountBook`.
    */
    R.modelName = "AccountBook";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "setAdmin": {
          url: urlBase + "/users/setAdmin",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.User#removeAdmin
         * @methodOf lbServices.User
         *
         * @description
         *
         ...
         */
        "removeAdmin": {
          url: urlBase + "/users/removeAdmin",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.User#getFromSession
         * @methodOf lbServices.User
         *
         * @description
         *
         ...
         */
        "getFromSession": {
          url: urlBase + "/users/getFromSession",
          method: "POST",
        },
